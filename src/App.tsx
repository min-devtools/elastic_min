...
import { ConnectionView as ConnectionViewImpl } from "./components/views/ConnectionView";
import { QueryView as QueryViewImpl } from "./components/views/QueryView";
import { QuickQueryView as QuickQueryViewImpl } from "./components/views/QuickQueryView";
import { DocsView as DocsViewImpl } from "./components/views/DocsView";
import { IndexesView as IndexesViewImpl } from "./components/views/IndexesView";
import { CreateIndexView as CreateIndexViewImpl } from "./components/views/CreateIndexView";
import { ClusterView as ClusterViewImpl } from "./components/views/ClusterView";
import { MappingView as MappingViewImpl } from "./components/views/MappingView";
...
import { IndexStatsView as IndexStatsViewImpl } from "./components/views/IndexStatsView";
import { SavedQueriesView as SavedQueriesViewImpl } from "./components/views/SavedQueriesView";
import { NodesView as NodesViewImpl } from "./components/views/NodesView";
import { OverviewView as OverviewViewImpl } from "./components/views/OverviewView";
import { ShardsView as ShardsViewImpl } from "./components/views/ShardsView";
import { ReindexView as ReindexViewImpl } from "./components/views/ReindexView";
import { TemplatesView as TemplatesViewImpl } from "./components/views/TemplatesView";
...
const ConnectionView = memo(ConnectionViewImpl);
const QueryView = memo(QueryViewImpl);
const QuickQueryView = memo(QuickQueryViewImpl);
const DocsView = memo(DocsViewImpl);
const IndexesView = memo(IndexesViewImpl);
const CreateIndexView = memo(CreateIndexViewImpl);
const ClusterView = memo(ClusterViewImpl);
const MappingView = memo(MappingViewImpl);
const SettingsView = memo(SettingsViewImpl);
const HistoryView = memo(HistoryViewImpl);
const IndexStatsView = memo(IndexStatsViewImpl);
const SavedQueriesView = memo(SavedQueriesViewImpl);
const NodesView = memo(NodesViewImpl);
const OverviewView = memo(OverviewViewImpl);
const ShardsView = memo(ShardsViewImpl);
const ReindexView = memo(ReindexViewImpl);
const TemplatesView = memo(TemplatesViewImpl);
...
function renderView(tab: TabDef, active: boolean) {
  switch (tab.kind) {
    ...
    case "nodes": return <NodesView key={tab.id} active={active} />;
    case "shards": return <ShardsView key={tab.id} active={active} />;
    case "overview": return <OverviewView key={tab.id} active={active} />;
    case "reindex": return <ReindexView key={tab.id} active={active} />;
    case "templates": return <TemplatesView key={tab.id} active={active} />;
